...
draft: false
tags: tdd, integration-tests, testcontainers, db-fixture, project-r
---
...
В целом я нашёл link:++{{<ref "/microposts/24/04/trainer-advisor-testing-test-suite-setup">}}++[схему подготовки БД], которая решает обе эти проблемы.
...
CREATE DATABASE project_u TEMPLATE project_u;
----
