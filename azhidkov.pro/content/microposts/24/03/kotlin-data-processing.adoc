...
public @NotNull String getRuValue(@Nullable ValueHolder valueHolder) {
    return Optional.ofNullable(valueHolder).map(ValueHolder::value).map(MultiLangValue::ru).orElse("");
}
----
|===
...
public static String getIfInstanceOf(Value value) {
    ...
    return ((MultiLangValue3) value).en;
}
----
|
a|
...
public static String getIfInstanceOfSwitch(Value value) {
    return switch (value) {
        case MultiLangValue3 multiLangValue3:
            yield multiLangValue3.en;
        default:
            yield null;
    };
}
