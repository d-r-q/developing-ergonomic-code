...
draft: false
tags: terminology, fp, oop, functional-architecture, ergo-approach
aliases:
- /microposts/24/09/what-is-fp
---
...
Если вы пишете код так - чудесно, этого достаточно для https://t.me/ergonomic_code/464[таких результатов].
...
. Рубеж обороны от переусложнения операции - на уровне гайдлайна запретить добавление 8-ой и далее зависимости в конструктор без созыва архитектурного комитета.
  А на ревью я начинаю придираться уже к 5-ой зависимости.
