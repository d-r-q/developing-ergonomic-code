...
- case
aliases:
- /microposts/23/09/spring-boot-native
---
...
Эксперементировать, естественно, я начал на котике - сервисе, реализующим интеграцию с ЕМИАС, о котором я link:++{{<ref "posts/23/08/emias-integration">}}++[уже писал].
