...
For the pilot project, they chose to make a prototype of a video capture system for a custom camera that would receive signals from one of their existing device.
